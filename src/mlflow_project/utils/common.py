...
def read_yaml(path_to_yaml: Path) -> ConfigBox:
    ...
    Raises:
        ...
        e: empty file
    Returns:
        ConfigBox: Content of yaml file in ConfigBox type
    """
    try:
...
def create_directories(path_to_directories: list, verbose=False):
    """
    Create list of directpries
    Args:
        path_to_directories (list): list of path directories
        verbose (bool, optional): whether to log or not
    """
...
def load_json(path: Path) -> ConfigBox:
    ...
    Args:
        path (Path): path to json file
    Returns:
        ConfigBox: data as class atrributes instead of dict
    """
    with open(path) as f:
        content = json.load(f)
